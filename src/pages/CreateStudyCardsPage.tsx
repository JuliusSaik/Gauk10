    ...
    <>
      <Box className="pb-6">
        <Box className="justify-between items-center flex mx-auto">
          <h1 className="ml-20 mt-10 mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
      ...
      <Box className="w-full mx-auto p-2 place-items-center">
        <Box className="flex-col w-4/5 justify-center border-1 border-blue-300 items-center bg-gray-800 text-white p-8 rounded-lg shadow-lg">
          ...
          />
          <p className="text-lg font-bold mb-2 mt-4">Studycard Description:</p>
          <TextField
            sx={{
              "& .MuiOutlinedInput-input": { color: "white" },
            }}
            ...
            className="mb-4 bg-gray-700 rounded-md outline-none"
          />
          <p className="text-lg font-bold mb-2 mt-4">Set Your Deadline:</p>
          <Box className="flex justify-between items-center">
            <DatePicker
              ...
              sx={{
                ...
                "& .MuiPickersDay-root": { color: "#F5F5F5" },
                "& .Mui-selected": {
